...
-- The Graduate Portal's Job Recommendations tab (server/lib/jobMatch.js) —
-- same cache-by-profile-hash pattern again, scored against the real jobs
-- table rather than a fixed catalog.
